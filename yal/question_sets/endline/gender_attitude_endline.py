...
ASSESSMENT_QUESTIONS = {
    ...
    # Gender Attitude
    {
        "start": "endline_9_q1_gender_attitude",
        "questions": {
            "endline_9_q1_gender_attitude": {
                "type": "list",
                "text": "\n".join(
                    [
                ...
                "next": "endline_9_q2_gender_attitude",
            },
            "endline_9_q2_gender_attitude": {
                "type": "list",
                "text": "\n".join(
                    [
                ...
                "next": "endline_9_q3_gender_attitude",
            },
            "endline_9_q3_gender_attitude": {
                "type": "list",
                "text": "\n".join(
                    [
                ...
                "next": "endline_9_q4_gender_attitude",
            },
            "endline_9_q4_gender_attitude": {
                "type": "list",
                "text": "\n".join(
                    [
